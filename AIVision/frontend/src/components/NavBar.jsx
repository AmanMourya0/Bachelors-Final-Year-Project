...
import AppLogo from '../../public/logo2.png'
...
function NavBar() {
  ...
  <div className="navbar-start wd-50">
    ...
    <img className='w-52' src={AppLogo} alt="App Logo" /></div> */}
    {/* <a className=" text-white text-2xl font-extrabold cursor-pointer">Scene<span className="text-cyan-400">Speak's</span></a> */}
    <a className="dark:text-white text-2xl font-extrabold cursor-pointer">AI <span className="text-cyan-400 hover:text-orange-500">Vision</span></a>
  </div>
  ...
  <label className="px-3 py-2 border border-cyan-400 rounded-md flex items-center gap-2  ">
  <input type="text" className="grow outline-none bg-slate-100 dark:bg-black" placeholder="Search" />
...
{authUser?(<Logout/>):
(<div>
<a  className="bg-white text-black dark:bg-black dark:text-cyan-400 dark:hover:bg-cyan-400 dark:hover:text-black px-3 py-2 rounded-md hover:bg-black hover:text-white duration-300 cursor:pointer"
  onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a><Login/></div>)}
